...
public class NaverLoginBO {
	...
	//state: ���ø����̼��� ������ ���� ��ū
	private final static String CLIENT_ID = "_eXpHwpM6yRnIuDaTTcR";
	private final static String CLIENT_SECRET = "HmouEO_Gpg";
	private final static String REDIRECT_URI = "http://192.168.0.225:8080/callback";
