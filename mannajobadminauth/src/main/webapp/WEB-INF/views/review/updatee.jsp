            ...
            <article>
                ...
                <div class="row">
                  ...
                  <div class="span9">                   
                    <h5>▶ 리뷰수정</h5>
                    <div class="">
                    <form method="post" name="updateform" target="showempl" action="/review/updateokk" class="form-horizontal span12">
                        ...
                        <div class="control-group center">            
                          <div class="">
                              ...
                              <p class="center">
                  				...
                  				<input  class="btn btn-inverse margintop10 i_btn2"  type="button" value="취소" onClick="window.close()">
                              </p>
                            </div>
                          </div>
                        </div>
