                      ...
                      <form method="post" name="insertform" target="matlist" action="/review/insertok" class="form-horizontal span12">
                        ...
                        <div class="control-group center">            
                          <div class="">
                              ...
                              <!-- 버튼영역 -->
                              <p class="center">
                                <input type="submit" value="등록" class="btn btn-theme margintop10 i_btn2" onClick="window.close()">
                                <input type="button" value="닫기" onClick="window.close()" class="btn btn-inverse margintop10 i_btn2">
                              </p>
                            </div>
                          </div>
                          </form>
